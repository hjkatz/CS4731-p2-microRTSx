...
/**
 * \brief Traffic used by units so that complex routing can be done where they
...
public class TrafficMap
{
    ...
    /**
     * Determines if the traffic can pass through this location at the given
     * time
     * 
     * @param location
     *            the location in the map
     * @param start
     *            when the traffic will start
     * @param end
     *            when the traffic will end
